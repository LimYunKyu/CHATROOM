...
inline ::PROTOBUF_NAMESPACE_ID::int64 Player::_internal_posx() const {
  return posx_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Player::posx() const {
  // @@protoc_insertion_point(field_get:Protocol.Player.posX)
  return _internal_posx();
}
inline void Player::_internal_set_posx(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  posx_ = value;
}
inline void Player::set_posx(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 Player::_internal_posy() const {
  return posy_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Player::posy() const {
  // @@protoc_insertion_point(field_get:Protocol.Player.posY)
  return _internal_posy();
}
inline void Player::_internal_set_posy(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  posy_ = value;
}
inline void Player::set_posy(::PROTOBUF_NAMESPACE_ID::int64 value) {

...
constexpr PlayerState PlayerState_MIN = PLAYER_STATE_IDLE;
constexpr PlayerState PlayerState_MAX = PLAYER_STATE_WALK;
...
enum PlayerDirection : int {
  PLAYER_DIR_RIGHT = 0,
  PLAYER_STATE_LEFT = 1,
  PlayerDirection_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  PlayerDirection_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool PlayerDirection_IsValid(int value);
constexpr PlayerDirection PlayerDirection_MIN = PLAYER_DIR_RIGHT;
constexpr PlayerDirection PlayerDirection_MAX = PLAYER_STATE_LEFT;
constexpr int PlayerDirection_ARRAYSIZE = PlayerDirection_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* PlayerDirection_descriptor();
template<typename T>
inline const std::string& PlayerDirection_Name(T enum_t_value) {
  static_assert(::std::is_same<T, PlayerDirection>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function PlayerDirection_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    PlayerDirection_descriptor(), enum_t_value);
}
inline bool PlayerDirection_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PlayerDirection* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<PlayerDirection>(
    PlayerDirection_descriptor(), name, value);
}
// ===================================================================
...
template <> struct is_proto_enum< ::Protocol::PlayerDirection> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::PlayerDirection>() {
  return ::Protocol::PlayerDirection_descriptor();
}
